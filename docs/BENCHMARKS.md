...
| `local_cluster` | `two_stage_hash_aggregate` | coordinator dispatch, plan decoding, partial states, loopback Flight exchange, final merge | rows/s, shuffle rows/bytes |
